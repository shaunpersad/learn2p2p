...
function blockFactory(hashes) {
    ...
    return class Block {
        ...
        static encode(data) {
            ...
            /**
             * Chunk the data into strings of MAX_DATA_LENGTH
             */
        ...
        static decode(hash) {
            ...
            /**
             * Add the original block's data to decoded data from its links.
             */
            return block.links.reduce((data, hash) => {

                return data + this.decode(hash);
